import { IconButton, Popover, PopoverTrigger, PopoverContent, PopoverBody, useColorMode, useDisclosure, Skeleton } from '@chakra-ui/react';
...
const ColorModeSwitch = () => {
  ...
  React.useEffect(() => {
    ...
    const fallbackHex = (COLOR_THEMES.find((theme) => theme.colorMode === nextColorMode && theme.colors.length === 1) ?? COLOR_THEMES[0])
      .colors[0].hex;
