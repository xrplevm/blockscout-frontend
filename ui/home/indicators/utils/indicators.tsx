...
const tvlIndicator: TChainIndicator<'stats_charts_market'> = {
  ...
  value: (stats) =>
    stats.tvl === null ? '$N/A' : '$' + Number(stats.tvl).toLocaleString(undefined, { maximumFractionDigits: 2, notation: 'compact' }),
...
const INDICATORS = [ dailyTxsIndicator, coinPriceIndicator, secondaryCoinPriceIndicator, marketPriceIndicator, tvlIndicator ];
